...
pub struct HttpRequestBody<String, T> {
...
impl<String, T> HttpRequestBody<String, T> {
...
pub fn handle_connection<String, T> (mut stream: TcpStream) -> HttpRequestBody<String, T> {
    ...
    let request_body_structure: HttpRequestBody<String, T> = serde_json::from_str(request_body)
